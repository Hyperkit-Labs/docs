...
<span class="text-slate-500">Response:</span>
{
  ...
  <span class="text-green-400">"current_stage"</span>: <span class="text-green-400">"auditing"</span>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-12 pt-8 border-t border-white/5">
            <Link href="/v0.1.0/hyperagent/api-reference/deployments" className="group block p-4 rounded-xl border border-white/10 hover:border-amber-500/30 hover:bg-white/5 transition-all">
            ...
            <Link href="/v0.1.0/hyperagent/api-reference/x402" className="group block p-4 rounded-xl border border-white/10 hover:border-amber-500/30 hover:bg-white/5 transition-all text-right">
