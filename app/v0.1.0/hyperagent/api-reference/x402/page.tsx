      ...
      <div className="flex flex-1 pt-14 w-full max-w-[1600px] mx-auto">
        ...
        <main className="flex-1 min-w-0 max-w-4xl mx-auto py-10 px-6 lg:px-12 pb-24">
          <div className="flex items-center gap-2 text-xs text-slate-500 mb-8 font-medium">
            ...
            <span>/</span>
            <Link href="/v0.1.0/hyperagent/api-reference" className="hover:text-slate-300 transition-colors">API Reference</Link>
            <span>/</span>
          ...
          <p className="leading-7 mb-6">
            To use x402 endpoints, you need to configure your Thirdweb client ID in the environment variables. See the <Link href="/v0.1.0/hyperagent/guides/x402-integration" className="text-amber-400 hover:text-amber-300 underline">x402 Integration Guide</Link> for setup instructions.
          </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-12 pt-8 border-t border-white/5">
            <Link href="/v0.1.0/hyperagent/api-reference/workflows" className="group block p-4 rounded-xl border border-white/10 hover:border-amber-500/30 hover:bg-white/5 transition-all">
            ...
            <Link href="/v0.1.0/hyperagent/api-reference/websocket" className="group block p-4 rounded-xl border border-white/10 hover:border-amber-500/30 hover:bg-white/5 transition-all text-right">
