  ...
  <span class="text-purple-400">-d</span> <span class="text-green-400">'{
    ...
    "constructor_args": []
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-12 pt-8 border-t border-white/5">
            <Link href="/v0.1.0/hyperagent/getting-started/local-setup" className="group block p-4 rounded-xl border border-white/10 hover:border-amber-500/30 hover:bg-white/5 transition-all">
            ...
            <Link href="/v0.1.0/hyperagent/concepts" className="group block p-4 rounded-xl border border-white/10 hover:border-amber-500/30 hover:bg-white/5 transition-all text-right">
