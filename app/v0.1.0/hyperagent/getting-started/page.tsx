      ...
      <div className="flex flex-1 pt-14 w-full max-w-[1600px] mx-auto">
        ...
        <main className="flex-1 min-w-0 max-w-4xl mx-auto py-10 px-6 lg:px-12 pb-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
            <Link
              href="/v0.1.0/hyperagent/getting-started/docker-setup"
            ...
            <Link
              href="/v0.1.0/hyperagent/getting-started/cloud-setup"
              className="group block p-6 rounded-xl border border-white/10 hover:border-amber-500/30 hover:bg-white/5 transition-all"
            >
            ...
            <Link
              href="/v0.1.0/hyperagent/getting-started/local-setup"
              className="group block p-6 rounded-xl border border-white/10 hover:border-amber-500/30 hover:bg-white/5 transition-all"
            >
  ...
  <span class="text-purple-400">-d</span> <span class="text-green-400">'{
    ...
    "contract_type": "token"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-12 pt-8 border-t border-white/5">
            <Link href="/v0.1.0/hyperagent" className="group block p-4 rounded-xl border border-white/10 hover:border-amber-500/30 hover:bg-white/5 transition-all">
            ...
            <Link href="/v0.1.0/hyperagent/getting-started/docker-setup" className="group block p-4 rounded-xl border border-white/10 hover:border-amber-500/30 hover:bg-white/5 transition-all text-right">
