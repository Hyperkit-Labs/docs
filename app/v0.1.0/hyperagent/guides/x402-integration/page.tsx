...
<span class="text-blue-400">THIRDWEB_CLIENT_ID</span>=<span class="text-green-400">your_client_id_here</span>`}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-12 pt-8 border-t border-white/5">
            <Link href="/v0.1.0/hyperagent/guides/multi-chain-deployment" className="group block p-4 rounded-xl border border-white/10 hover:border-amber-500/30 hover:bg-white/5 transition-all">
            ...
            <Link href="/v0.1.0/hyperagent/guides/parallel-deployment" className="group block p-4 rounded-xl border border-white/10 hover:border-amber-500/30 hover:bg-white/5 transition-all text-right">
