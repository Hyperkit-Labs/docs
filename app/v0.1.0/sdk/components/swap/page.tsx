  ...
  <span class="text-purple-400">return</span> (
    ...
    <span class="text-purple-400">/&gt;</span>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-12 pt-8 border-t border-white/5">
            <Link href="/v0.1.0/sdk/components/connect-wallet" className="group block p-4 rounded-xl border border-white/10 hover:border-purple-500/30 hover:bg-white/5 transition-all">
            ...
            <Link href="/v0.1.0/sdk/components/bridge" className="group block p-4 rounded-xl border border-white/10 hover:border-purple-500/30 hover:bg-white/5 transition-all text-right">
