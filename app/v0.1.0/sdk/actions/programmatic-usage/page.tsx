      ...
      <div className="flex flex-1 pt-14 w-full max-w-[1600px] mx-auto">
        ...
        <main className="flex-1 min-w-0 max-w-4xl mx-auto py-10 px-6 lg:px-12 pb-24">
          <div className="flex items-center gap-2 text-xs text-slate-500 mb-8 font-medium">
            ...
            <span>/</span>
            <Link href="/v0.1.0/sdk/actions" className="hover:text-slate-300 transition-colors">Actions API</Link>
            <span>/</span>
...
<span class="text-purple-400">function</span> <span class="text-blue-400">CustomSwap</span>() {
  ...
  <span class="text-purple-400">&lt;/</span><span class="text-blue-400">button</span><span class="text-purple-400">&gt;</span>;
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-12 pt-8 border-t border-white/5">
            <Link href="/v0.1.0/sdk/actions" className="group block p-4 rounded-xl border border-white/10 hover:border-purple-500/30 hover:bg-white/5 transition-all">
            ...
            <Link href="/v0.1.0/sdk/configuration" className="group block p-4 rounded-xl border border-white/10 hover:border-purple-500/30 hover:bg-white/5 transition-all text-right">
