  ...
  <span class="text-purple-400">return</span> <span class="text-purple-400">&lt;</span><span class="text-blue-400">p</span><span class="text-purple-400">&gt;</span>Connected as: {wallet.account}<span class="text-purple-400">&lt;/</span><span class="text-blue-400">p</span><span class="text-purple-400">&gt;</span>;
          ...
          <div className="space-y-4 mb-8">
            <div className="p-4 rounded-lg border border-white/10 bg-white/5">
              ...
              <Link href="/v0.1.0/sdk/components" className="text-xs text-purple-400 hover:underline inline-flex items-center gap-1">
            ...
            <div className="p-4 rounded-lg border border-white/10 bg-white/5">
              ...
              <Link href="/v0.1.0/sdk/hooks" className="text-xs text-purple-400 hover:underline inline-flex items-center gap-1">
            ...
            <div className="p-4 rounded-lg border border-white/10 bg-white/5">
              ...
              <Link href="/v0.1.0/sdk/examples" className="text-xs text-purple-400 hover:underline inline-flex items-center gap-1">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-12 pt-8 border-t border-white/5">
            <Link href="/v0.1.0/sdk" className="group block p-4 rounded-xl border border-white/10 hover:border-purple-500/30 hover:bg-white/5 transition-all">
            ...
            <Link href="/v0.1.0/sdk/components" className="group block p-4 rounded-xl border border-white/10 hover:border-purple-500/30 hover:bg-white/5 transition-all text-right">
