...
<span class="text-purple-400">const</span> poolAddress = CONTRACT_ADDRESSES.LIQUIDITY_POOL;`}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8 mt-8">
            <Link href="/v0.1.0/sdk/configuration/networks" className="group block p-6 rounded-xl border border-white/10 hover:border-purple-500/30 hover:bg-white/5 transition-all">
            ...
            <Link href="/v0.1.0/sdk/configuration/tokens" className="group block p-6 rounded-xl border border-white/10 hover:border-purple-500/30 hover:bg-white/5 transition-all">
            ...
            <Link href="/v0.1.0/sdk/configuration/contracts" className="group block p-6 rounded-xl border border-white/10 hover:border-purple-500/30 hover:bg-white/5 transition-all">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-12 pt-8 border-t border-white/5">
            <Link href="/v0.1.0/sdk/actions/programmatic-usage" className="group block p-4 rounded-xl border border-white/10 hover:border-purple-500/30 hover:bg-white/5 transition-all">
            ...
            <Link href="/v0.1.0/sdk/configuration/networks" className="group block p-4 rounded-xl border border-white/10 hover:border-purple-500/30 hover:bg-white/5 transition-all text-right">
