    ...
    <span class="text-purple-400">/&gt;</span>
          ...
          <div className="space-y-4 mb-8">
            <div className="p-4 rounded-lg border border-white/10 bg-white/5">
              ...
              <Link href="/v0.1.0/aa-hyperwallet/concepts" className="text-xs text-violet-400 hover:underline inline-flex items-center gap-1">
            ...
            <div className="p-4 rounded-lg border border-white/10 bg-white/5">
              ...
              <Link href="/v0.1.0/aa-hyperwallet/builder" className="text-xs text-violet-400 hover:underline inline-flex items-center gap-1">
            ...
            <div className="p-4 rounded-lg border border-white/10 bg-white/5">
              ...
              <Link href="/v0.1.0/aa-hyperwallet/examples" className="text-xs text-violet-400 hover:underline inline-flex items-center gap-1">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-12 pt-8 border-t border-white/5">
            <Link href="/v0.1.0/aa-hyperwallet" className="group block p-4 rounded-xl border border-white/10 hover:border-violet-500/30 hover:bg-white/5 transition-all">
            ...
            <Link href="/v0.1.0/aa-hyperwallet/concepts" className="group block p-4 rounded-xl border border-white/10 hover:border-violet-500/30 hover:bg-white/5 transition-all text-right">
