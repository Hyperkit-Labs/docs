      ...
      <div className="flex flex-1 pt-14 w-full max-w-[1600px] mx-auto">
        ...
        <main className="flex-1 min-w-0 max-w-4xl mx-auto py-10 px-6 lg:px-12 pb-24">
          <div className="flex items-center gap-2 text-xs text-slate-500 mb-8 font-medium">
            ...
            <span>/</span>
            <Link href="/v0.1.0/erc1066-x402/guides" className="hover:text-slate-300 transition-colors">Guides</Link>
            <span>/</span>
          ...
          <Callout type="info" title="Network-Agnostic Design">
            The gateway uses Chainlist for automatic RPC discovery, so you can add new networks without code changes. See the <Link href="/v0.1.0/erc1066-x402/guides/gateway-setup" className="text-indigo-400 hover:underline">Gateway Setup</Link> guide for configuration details.
          </Callout>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-12 pt-8 border-t border-white/5">
            <Link href="/v0.1.0/erc1066-x402/guides/agent-integration" className="group block p-4 rounded-xl border border-white/10 hover:border-indigo-500/30 hover:bg-white/5 transition-all">
            ...
            <Link href="/v0.1.0/erc1066-x402/guides/deployment" className="group block p-4 rounded-xl border border-white/10 hover:border-indigo-500/30 hover:bg-white/5 transition-all text-right">
