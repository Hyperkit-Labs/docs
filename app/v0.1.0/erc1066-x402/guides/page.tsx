      ...
      <div className="flex flex-1 pt-14 w-full max-w-[1600px] mx-auto">
        ...
        <main className="flex-1 min-w-0 max-w-4xl mx-auto py-10 px-6 lg:px-12 pb-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
            <Link
              href="/v0.1.0/erc1066-x402/guides/gateway-setup"
            ...
            <Link
              href="/v0.1.0/erc1066-x402/guides/agent-integration"
              className="group block p-6 rounded-xl border border-white/10 hover:border-indigo-500/30 hover:bg-white/5 transition-all"
            >
            ...
            <Link
              href="/v0.1.0/erc1066-x402/guides/multi-chain"
              className="group block p-6 rounded-xl border border-white/10 hover:border-indigo-500/30 hover:bg-white/5 transition-all"
            >
            ...
            <Link
              href="/v0.1.0/erc1066-x402/guides/deployment"
              className="group block p-6 rounded-xl border border-white/10 hover:border-indigo-500/30 hover:bg-white/5 transition-all"
            >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-12 pt-8 border-t border-white/5">
            <Link href="/v0.1.0/erc1066-x402/concepts" className="group block p-4 rounded-xl border border-white/10 hover:border-indigo-500/30 hover:bg-white/5 transition-all">
