...
<span class="text-purple-400">NODE_ENV</span>=<span class="text-green-400">development</span>`}
          ...
          <Callout type="info" title="Network-Agnostic Design">
            The gateway automatically discovers RPC endpoints via Chainlist, so you can add new networks without code changes. See the <Link href="/v0.1.0/erc1066-x402/guides/multi-chain" className="text-indigo-400 hover:underline">Multi-Chain Guide</Link> for details.
          </Callout>
...
<span class="text-blue-400">curl</span> <span class="text-purple-400">-X</span> POST http://localhost:3001/intents/validate \\
  ...
  <span class="text-purple-400">-d</span> <span class="text-green-400">'{...}'</span>`}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-12 pt-8 border-t border-white/5">
            ...
            <Link href="/v0.1.0/erc1066-x402/guides/agent-integration" className="group block p-4 rounded-xl border border-white/10 hover:border-indigo-500/30 hover:bg-white/5 transition-all text-right">
