...
<span class="text-blue-400">cast</span> call <EXECUTOR_ADDRESS> <span class="text-green-400">"validator()"</span> <span class="text-purple-400">--rpc-url</span> <RPC_URL>`}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-12 pt-8 border-t border-white/5">
            <Link href="/v0.1.0/erc1066-x402/guides/multi-chain" className="group block p-4 rounded-xl border border-white/10 hover:border-indigo-500/30 hover:bg-white/5 transition-all">
            ...
            <Link href="/v0.1.0/erc1066-x402/guides" className="group block p-4 rounded-xl border border-white/10 hover:border-indigo-500/30 hover:bg-white/5 transition-all text-right">
