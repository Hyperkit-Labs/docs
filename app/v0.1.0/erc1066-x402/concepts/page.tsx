...
import { StatusCodeTable } from '@/v01/components/pages/docs-status-code-table';
...
<span class="text-purple-400">elif</span> result.status == <span class="text-green-400">"0x20"</span>:  <span class="text-slate-500"># TOO_EARLY</span>
    schedule_retry(result.retry_after)`}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-12 pt-8 border-t border-white/5">
            <Link href="/v0.1.0/erc1066-x402/getting-started" className="group block p-4 rounded-xl border border-white/10 hover:border-indigo-500/30 hover:bg-white/5 transition-all">
