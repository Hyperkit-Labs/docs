...
import { Callout } from '@/v01/components/pages/docs-callout';
...
<span class="text-blue-400">git</span> <span class="text-purple-400">--version</span>`}
          ...
          <Callout type="info" title="Optional: Multi-Chain Support">
            For Solana or Sui support, you'll also need Anchor (Solana) or Sui CLI. See the <Link href="/v0.1.0/erc1066-x402/guides/multi-chain" className="text-indigo-400 hover:underline">Multi-Chain Guide</Link> for details.
          </Callout>
    ...
    <span class="text-blue-400">print</span>(<span class="text-green-400">f"Validation failed: {result.status}"</span>)`}
          ...
          <div className="space-y-4 mb-8">
            <div className="p-4 rounded-lg border border-white/10 bg-white/5">
              ...
              <Link href="/v0.1.0/erc1066-x402/concepts" className="text-xs text-indigo-400 hover:underline inline-flex items-center gap-1">
            ...
            <div className="p-4 rounded-lg border border-white/10 bg-white/5">
              ...
              <Link href="/v0.1.0/erc1066-x402/guides/gateway-setup" className="text-xs text-indigo-400 hover:underline inline-flex items-center gap-1">
            ...
            <div className="p-4 rounded-lg border border-white/10 bg-white/5">
              ...
              <Link href="/v0.1.0/erc1066-x402/examples" className="text-xs text-indigo-400 hover:underline inline-flex items-center gap-1">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-12 pt-8 border-t border-white/5">
            <Link href="/v0.1.0/erc1066-x402" className="group block p-4 rounded-xl border border-white/10 hover:border-indigo-500/30 hover:bg-white/5 transition-all">
            ...
            <Link href="/v0.1.0/erc1066-x402/concepts" className="group block p-4 rounded-xl border border-white/10 hover:border-indigo-500/30 hover:bg-white/5 transition-all text-right">
