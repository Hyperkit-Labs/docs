...
<span class="text-purple-400">elif</span> action == <span class="text-green-400">'request_payment'</span>:
    request_payment(result[<span class="text-green-400">'payment_url'</span>])`}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-12 pt-8 border-t border-white/5">
            <Link href="/v0.1.0/erc1066-x402/api-reference/sdk/typescript" className="group block p-4 rounded-xl border border-white/10 hover:border-indigo-500/30 hover:bg-white/5 transition-all">
            ...
            <Link href="/v0.1.0/erc1066-x402/api-reference" className="group block p-4 rounded-xl border border-white/10 hover:border-indigo-500/30 hover:bg-white/5 transition-all text-right">
